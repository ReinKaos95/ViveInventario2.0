    ...
    <div class="row">
        ...
        <select class="form-control form-select " name="equipos_eq_id" >
    		    ...
    		    <div class="col-md-8 banner-sec rounded">
                    <div class="px-2 py-3 position-absolute rounded-left" style="background-color: rgba(255,255,255,0.5);bottom: 40px;">
                        <h2>Есле Вы не зарегестрированы | <span style="font-size: .5em;">Новый клиент</span></h2>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item bg-transparent border-0 p-1"><i class="far fa-check-square text-primary"></i> Легко и удобно оформлять заказы. Вам не нужно будет повторно вводить информацию о способах доставки.</li>
                            <li class="list-group-item bg-transparent border-0 p-1"><i class="far fa-check-square text-primary"></i> Сайт будет автоматически узнавать вас и, где необходимо, предоставлять информацию для оформления заказа, и автоматически предоставлять доступ к вашей учетной записи.</li>
                            <li class="list-group-item bg-transparent border-0 p-1"><i class="far fa-check-square text-primary"></i> Редактировать свои данные в Личном кабинете</li>
                            <li class="list-group-item bg-transparent border-0 p-1"><i class="far fa-check-square text-primary"></i> Просматривать статус платежей и заявок на обмен в Истории заявок/платежей.</li>
                            <li class="list-group-item bg-transparent border-0 p-1"><i class="far fa-check-square text-primary"></i> Участвовать в партнерской программе и получать скидки на товары и услуги, представленные на сайте.</li>
                        </ul>
                        <p>Если Вы зарегестрированы, то войдите в свой аккаунт:</p>
                    </div>
        		</div>
        	</div>
        </div>
